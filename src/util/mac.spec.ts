...
const machoTypes = [
	...
	},
	{
		...
		data: unhex([
			...
			'00 00 00 12 00 00 00 64 00 00 00 00 00 00 00 00 00 00 00 00',
			'01 00 00 12 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00',
			'00 00 00 07 00 00 00 03 00 00 00 00 00 00 00 00 00 00 00 00',
			'01 00 00 07 00 00 00 03 00 00 00 00 00 00 00 00 00 00 00 00'
		].join('')),
		format: [
			{
				cpuType: 0x00000012,
